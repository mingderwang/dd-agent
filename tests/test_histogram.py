...
class TestHistogram(unittest.TestCase):
    ...
    def test_custom_single_percentile(self):
        ...
        self.assertEquals(stats.histogram_percentiles, [0.40], stats.histogram_percentiles)
    ...
    def test_custom_multiple_percentile(self):
        ...
        self.assertEquals(stats.histogram_percentiles, [0.4, 0.65, 0.99],
            stats.histogram_percentiles)
    ...
    def test_custom_invalid_percentile(self):
        ...
        self.assertEquals(stats.histogram_percentiles, DEFAULT_HISTOGRAM_PERCENTILES,
            stats.histogram_percentiles)
    ...
    def test_custom_invalid_percentile3skip(self):
        ...
        self.assertEquals(stats.histogram_percentiles, [0.8],
            stats.histogram_percentiles)
    ...
    def test_custom_aggregate(self):
        ...
        self.assertEquals(
            sorted(stats.histogram_aggregates),
            ['max', 'median'],
            stats.histogram_aggregates
        )
