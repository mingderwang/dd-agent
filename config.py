...
def get_histogram_aggregates(configstr=None):
    if configstr is None:
        return DEFAULT_HISTOGRAM_AGGREGATES
    ...
    try:
        ...
        log.exception("Error when parsing histogram aggregates, using default")
        return DEFAULT_HISTOGRAM_AGGREGATES
...
def get_histogram_percentiles(configstr=None):
    ...
    try:
        ...
        log.exception("Error when parsing histogram percentiles, using default")
        return DEFAULT_HISTOGRAM_PERCENTILES
